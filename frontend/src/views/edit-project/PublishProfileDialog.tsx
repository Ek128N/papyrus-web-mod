                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      onChange={(event) => onCheckboxChange('Development')}
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      onChange={(event) => onCheckboxChange('Release')}
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      onChange={(event) => onCheckboxChange('Major')}
                    />
                  }
                  label="Major release"
                />
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      onChange={(event) => onCheckboxChange('Custom')}
                    />
                  }
                  label="Custom"
                />
