...
public class NonDerivedMonoValuedNonContainmentReferenceIfDescriptionProvider {
    ...
    private final Logger logger = LoggerFactory.getLogger(NonDerivedMonoValuedNonContainmentReferenceIfDescriptionProvider.class);

    public NonDerivedMonoValuedNonContainmentReferenceIfDescriptionProvider(ComposedAdapterFactory composedAdapterFactory, IObjectService objectService,
    ...
    private Function<VariableManager, Boolean> getPredicate() {
        return variableManager -> {
            ...
            return optionalEReference.filter(eReference -> {
                ...
                isCandidate = isCandidate && !eReference.isDerived();
                return isCandidate;
            }).isPresent();
        };
    }
