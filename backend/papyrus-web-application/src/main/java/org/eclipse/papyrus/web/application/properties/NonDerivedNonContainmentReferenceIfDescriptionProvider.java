...
public class NonDerivedNonContainmentReferenceIfDescriptionProvider {
    ...
    private ReferenceWidgetDescription getReferenceWidgetDescription() {
        return ReferenceWidgetDescription.newReferenceWidgetDescription(REFERENCE_WIDGET_DESCRIPTION_ID).targetObjectIdProvider(this.semanticTargetIdProvider) //
                ...
                .kindProvider(object -> "").messageProvider(object -> "") //
