...
public class UCDReconnectEdgeTargetTest extends ReconnectEdgeTargetTest {
    ...
    public void testReconnectEdgeSource() {
        ...
        Checker graphicalChecker = new EdgeTargetGraphicalChecker(() -> this.findGraphicalElementByLabel("UseCase2"));
        this.reconnectEdgeTarget(edge.getId(), "UseCase2", graphicalChecker);
