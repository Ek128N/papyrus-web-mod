...
public class UCDSubNodeGraphicalDeletionTest extends NodeDeletionTest {
    ...
    private static Stream<Arguments> parameterProvider() {
        return Stream.of(//
                Arguments.of(ACTOR1, PACKAGED_ELEMENT), //
                Arguments.of(USE_CASE1, PACKAGED_ELEMENT)//
        );
    }
    ...
    public void setUp() {
        ...
        String packageDiagramElementId = this.getGraphicalOwner().getId();
        this.applyNodeCreationTool(packageDiagramElementId, new UCDCreationTool(UCDToolSections.NODES, UML.getActor()));
        this.applyNodeCreationTool(packageDiagramElementId, new UCDCreationTool(UCDToolSections.NODES, UML.getUseCase()));
    }
    ...
    public void testDeleteGraphicalNodeInPackage(String elementName, EReference containmentReference) {
        DeletionGraphicalChecker graphicalChecker = new DeletionGraphicalChecker(() -> this.getDiagram(), this::getGraphicalOwner);
        NodeGraphicalDeletionSemanticChecker semanticChecker = new NodeGraphicalDeletionSemanticChecker(this.getObjectService(), () -> this.getEditingContext(), () -> this.getSemanticOwner(),
