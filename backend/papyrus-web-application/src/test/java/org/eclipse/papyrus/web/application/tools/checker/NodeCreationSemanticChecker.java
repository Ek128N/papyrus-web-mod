...
public class NodeCreationSemanticChecker extends CreationSemanticChecker {
     ...
     */
    public NodeCreationSemanticChecker(ObjectService objectService, Supplier<IEditingContext> editingContextSupplier, EClass expectedType, Supplier<EObject> expectedOwnerSupplier,
