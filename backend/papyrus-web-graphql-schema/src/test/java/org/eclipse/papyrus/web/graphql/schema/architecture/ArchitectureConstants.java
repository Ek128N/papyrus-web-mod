 ...
 *******************************************************************************/
package org.eclipse.papyrus.web.graphql.schema.architecture;
...
public final class ArchitectureConstants {
    public static final String SIRIUS_WEB_GRAPHQL_SCHEMA_ROOT_PACKAGE = "org.eclipse.papyrus.web.graphql.schema.."; //$NON-NLS-1$
