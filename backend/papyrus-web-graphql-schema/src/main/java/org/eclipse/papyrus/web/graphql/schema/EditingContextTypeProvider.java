 ...
 *******************************************************************************/
package org.eclipse.papyrus.web.graphql.schema;
...
public class EditingContextTypeProvider {
    ...
    public static final String EDITING_CONTEXT_UML_STEREOTYPES_FIELD = "stereotypeMetatadas"; //$NON-NLS-1$

    public static final String EDITING_CONTEXT_UML_PROFILE_LAST_VERSION_FIELD = "profileLastVersion"; //$NON-NLS-1$
    ...
    public static final String ELEMENT_ID_ARGUMENT = "elementId"; //$NON-NLS-1$
