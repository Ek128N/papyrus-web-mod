...
public class Variables {
    ...
    public static final String DROPPED_NODE = "droppedNode"; //$NON-NLS-1$

    public static final String DROPPED_ELEMENT = "droppedElement"; //$NON-NLS-1$

    public static final String TARGET_NODE = "targetNode"; //$NON-NLS-1$

    public static final String TARGET_ELEMENT = "targetElement"; //$NON-NLS-1$
