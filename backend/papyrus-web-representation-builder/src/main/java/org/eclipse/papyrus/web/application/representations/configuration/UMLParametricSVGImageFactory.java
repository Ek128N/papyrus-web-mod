...
public class UMLParametricSVGImageFactory implements IParametricSVGImageFactory {
    ...
    private final Logger logger = LoggerFactory.getLogger(UMLParametricSVGImageFactory.class);

    private final List<IParametricSVGImageRegistry> parametricSVGImageServices;

    public UMLParametricSVGImageFactory(List<IParametricSVGImageRegistry> parametricSVGImageServices) {
    ...
    public Optional<byte[]> createSvg(String svgName, EnumMap<SVGAttribute, String> attributesValues) {
        ...
        if (svgImageOpt.isPresent()) {
            ...
            try (InputStream inputStream = classPathResource.getInputStream()) {
                ...
                if (ParametricSVGImageRegistryCustomImpl.PARAMETRIC_CLASS_IMAGE_ID.equals(parametricSVGImage.getId())
                        || ParametricSVGImageRegistryCustomImpl.PARAMETRIC_PACKAGE_IMAGE_ID.equals(parametricSVGImage.getId())) {
                    this.updateClassOrPackageSVG(attributesValues, parametricSVGImage, document);
                } else if (ParametricSVGImageRegistryCustomImpl.PARAMETRIC_NOTE_IMAGE_ID.equals(parametricSVGImage.getId())) {
                    this.updateNoteSVG(attributesValues, parametricSVGImage, document);
                } else if (ParametricSVGImageRegistryCustomImpl.PARAMETRIC_FORK_IMAGE_ID.equals(parametricSVGImage.getId())
                        || ParametricSVGImageRegistryCustomImpl.PARAMETRIC_JOIN_IMAGE_ID.equals(parametricSVGImage.getId())) {
