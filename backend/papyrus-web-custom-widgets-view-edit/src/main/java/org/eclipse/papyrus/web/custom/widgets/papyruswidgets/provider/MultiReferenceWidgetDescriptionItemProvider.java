...
public class MultiReferenceWidgetDescriptionItemProvider extends WidgetDescriptionItemProvider {
    ...
    protected void addIsEnabledExpressionPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description",
                        "_UI_MultiReferenceWidgetDescription_isEnabledExpression_feature",
                        "_UI_MultiReferenceWidgetDescription_type"),
                PapyrusWidgetsPackage.Literals.MULTI_REFERENCE_WIDGET_DESCRIPTION__IS_ENABLED_EXPRESSION, true, false,
                false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }

    /**
     * This adds a property descriptor for the Owner Expression feature. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    protected void addOwnerExpressionPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description",
                        "_UI_MultiReferenceWidgetDescription_ownerExpression_feature",
                        "_UI_MultiReferenceWidgetDescription_type"),
                PapyrusWidgetsPackage.Literals.MULTI_REFERENCE_WIDGET_DESCRIPTION__OWNER_EXPRESSION, true, false, false,
    ...
    protected void addTypePropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description", "_UI_MultiReferenceWidgetDescription_type_feature",
                        "_UI_MultiReferenceWidgetDescription_type"),
                PapyrusWidgetsPackage.Literals.MULTI_REFERENCE_WIDGET_DESCRIPTION__TYPE, true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addValueExpressionPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description",
                        "_UI_MultiReferenceWidgetDescription_valueExpression_feature",
                        "_UI_MultiReferenceWidgetDescription_type"),
                PapyrusWidgetsPackage.Literals.MULTI_REFERENCE_WIDGET_DESCRIPTION__VALUE_EXPRESSION, true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }

    /**
     * This adds a property descriptor for the Candidates Search Scope Expression
    ...
    protected void addCandidatesSearchScopeExpressionPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description",
                        "_UI_MultiReferenceWidgetDescription_candidatesSearchScopeExpression_feature",
                        "_UI_MultiReferenceWidgetDescription_type"),
    ...
    /**
     * This adds a property descriptor for the Dropdown Options Expression feature.
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    protected void addDropdownOptionsExpressionPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description",
                        "_UI_MultiReferenceWidgetDescription_dropdownOptionsExpression_feature",
                        "_UI_MultiReferenceWidgetDescription_type"),
                PapyrusWidgetsPackage.Literals.MULTI_REFERENCE_WIDGET_DESCRIPTION__DROPDOWN_OPTIONS_EXPRESSION, true,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (this.childrenFeatures == null) {
            ...
            this.childrenFeatures
                    .add(PapyrusWidgetsPackage.Literals.MULTI_REFERENCE_WIDGET_DESCRIPTION__CREATE_ELEMENT_OPERATION);
            this.childrenFeatures.add(PapyrusWidgetsPackage.Literals.MULTI_REFERENCE_WIDGET_DESCRIPTION__ADD_OPERATION);
            this.childrenFeatures
                    .add(PapyrusWidgetsPackage.Literals.MULTI_REFERENCE_WIDGET_DESCRIPTION__REMOVE_OPERATION);
            this.childrenFeatures
                    .add(PapyrusWidgetsPackage.Literals.MULTI_REFERENCE_WIDGET_DESCRIPTION__CLEAR_OPERATION);
            this.childrenFeatures
                    .add(PapyrusWidgetsPackage.Literals.MULTI_REFERENCE_WIDGET_DESCRIPTION__REORDER_OPERATION);
            this.childrenFeatures
                    .add(PapyrusWidgetsPackage.Literals.MULTI_REFERENCE_WIDGET_DESCRIPTION__CLICK_OPERATION);
            this.childrenFeatures.add(PapyrusWidgetsPackage.Literals.MULTI_REFERENCE_WIDGET_DESCRIPTION__STYLE);
            this.childrenFeatures
                    .add(PapyrusWidgetsPackage.Literals.MULTI_REFERENCE_WIDGET_DESCRIPTION__CONDITIONAL_STYLES);
        }
    ...
    /**
     * This returns MultiReferenceWidgetDescription.gif. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated NOT
     */
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_MultiReferenceWidgetDescription_type")
                : this.getString("_UI_MultiReferenceWidgetDescription_type") + " " + label;
    }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(this.createChildParameter(
                PapyrusWidgetsPackage.Literals.MULTI_REFERENCE_WIDGET_DESCRIPTION__CREATE_ELEMENT_OPERATION,
                PapyrusWidgetsFactory.eINSTANCE.createCreateElementInReferenceOperation()));

        newChildDescriptors.add(this.createChildParameter(
                PapyrusWidgetsPackage.Literals.MULTI_REFERENCE_WIDGET_DESCRIPTION__ADD_OPERATION,
                PapyrusWidgetsFactory.eINSTANCE.createMultiReferenceAddOperation()));

        newChildDescriptors.add(this.createChildParameter(
                PapyrusWidgetsPackage.Literals.MULTI_REFERENCE_WIDGET_DESCRIPTION__REMOVE_OPERATION,
                PapyrusWidgetsFactory.eINSTANCE.createMultiReferenceRemoveOperation()));

        newChildDescriptors.add(this.createChildParameter(
                PapyrusWidgetsPackage.Literals.MULTI_REFERENCE_WIDGET_DESCRIPTION__CLEAR_OPERATION,
                PapyrusWidgetsFactory.eINSTANCE.createClearReferenceOperation()));

        newChildDescriptors.add(this.createChildParameter(
                PapyrusWidgetsPackage.Literals.MULTI_REFERENCE_WIDGET_DESCRIPTION__REORDER_OPERATION,
                PapyrusWidgetsFactory.eINSTANCE.createMultiReferenceReorderOperation()));

        newChildDescriptors.add(this.createChildParameter(
                PapyrusWidgetsPackage.Literals.MULTI_REFERENCE_WIDGET_DESCRIPTION__CLICK_OPERATION,
                PapyrusWidgetsFactory.eINSTANCE.createClickReferenceValueOperation()));

        newChildDescriptors
                .add(this.createChildParameter(PapyrusWidgetsPackage.Literals.MULTI_REFERENCE_WIDGET_DESCRIPTION__STYLE,
        ...
        newChildDescriptors.add(this.createChildParameter(
                PapyrusWidgetsPackage.Literals.MULTI_REFERENCE_WIDGET_DESCRIPTION__CONDITIONAL_STYLES,
                ReferenceFactory.eINSTANCE.createConditionalReferenceWidgetDescriptionStyle()));
    }
