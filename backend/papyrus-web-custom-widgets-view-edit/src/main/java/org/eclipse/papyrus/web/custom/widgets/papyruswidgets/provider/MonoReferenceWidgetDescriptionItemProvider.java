...
public class MonoReferenceWidgetDescriptionItemProvider extends WidgetDescriptionItemProvider {
    ...
    protected void addIsEnabledExpressionPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description",
                        "_UI_MonoReferenceWidgetDescription_isEnabledExpression_feature",
                        "_UI_MonoReferenceWidgetDescription_type"),
                PapyrusWidgetsPackage.Literals.MONO_REFERENCE_WIDGET_DESCRIPTION__IS_ENABLED_EXPRESSION, true, false,
    ...
    protected void addOwnerExpressionPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description",
                        "_UI_MonoReferenceWidgetDescription_ownerExpression_feature",
                        "_UI_MonoReferenceWidgetDescription_type"),
                PapyrusWidgetsPackage.Literals.MONO_REFERENCE_WIDGET_DESCRIPTION__OWNER_EXPRESSION, true, false, false,
    ...
    protected void addTypePropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description", "_UI_MonoReferenceWidgetDescription_type_feature",
                        "_UI_MonoReferenceWidgetDescription_type"),
                PapyrusWidgetsPackage.Literals.MONO_REFERENCE_WIDGET_DESCRIPTION__TYPE, true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addValueExpressionPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description",
                        "_UI_MonoReferenceWidgetDescription_valueExpression_feature",
                        "_UI_MonoReferenceWidgetDescription_type"),
                PapyrusWidgetsPackage.Literals.MONO_REFERENCE_WIDGET_DESCRIPTION__VALUE_EXPRESSION, true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addCandidatesSearchScopeExpressionPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description",
                        "_UI_MonoReferenceWidgetDescription_candidatesSearchScopeExpression_feature",
                        "_UI_MonoReferenceWidgetDescription_type"),
    ...
    protected void addDropdownOptionsExpressionPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description",
                        "_UI_MonoReferenceWidgetDescription_dropdownOptionsExpression_feature",
                        "_UI_MonoReferenceWidgetDescription_type"),
                PapyrusWidgetsPackage.Literals.MONO_REFERENCE_WIDGET_DESCRIPTION__DROPDOWN_OPTIONS_EXPRESSION, true,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (this.childrenFeatures == null) {
            ...
            this.childrenFeatures
                    .add(PapyrusWidgetsPackage.Literals.MONO_REFERENCE_WIDGET_DESCRIPTION__CREATE_ELEMENT_OPERATION);
            this.childrenFeatures.add(PapyrusWidgetsPackage.Literals.MONO_REFERENCE_WIDGET_DESCRIPTION__SET_OPERATION);
            this.childrenFeatures
                    .add(PapyrusWidgetsPackage.Literals.MONO_REFERENCE_WIDGET_DESCRIPTION__UNSET_OPERATION);
            this.childrenFeatures
                    .add(PapyrusWidgetsPackage.Literals.MONO_REFERENCE_WIDGET_DESCRIPTION__CLEAR_OPERATION);
            this.childrenFeatures
                    .add(PapyrusWidgetsPackage.Literals.MONO_REFERENCE_WIDGET_DESCRIPTION__CLICK_OPERATION);
            this.childrenFeatures.add(PapyrusWidgetsPackage.Literals.MONO_REFERENCE_WIDGET_DESCRIPTION__STYLE);
            this.childrenFeatures
                    .add(PapyrusWidgetsPackage.Literals.MONO_REFERENCE_WIDGET_DESCRIPTION__CONDITIONAL_STYLES);
        }
    ...
    /**
     * This returns MonoReferenceWidgetDescription.gif. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @generated NOT
     */
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_MonoReferenceWidgetDescription_type")
                : this.getString("_UI_MonoReferenceWidgetDescription_type") + " " + label;
    }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(this.createChildParameter(
                PapyrusWidgetsPackage.Literals.MONO_REFERENCE_WIDGET_DESCRIPTION__CREATE_ELEMENT_OPERATION,
                PapyrusWidgetsFactory.eINSTANCE.createCreateElementInReferenceOperation()));

        newChildDescriptors.add(this.createChildParameter(
                PapyrusWidgetsPackage.Literals.MONO_REFERENCE_WIDGET_DESCRIPTION__SET_OPERATION,
                PapyrusWidgetsFactory.eINSTANCE.createMonoReferenceSetOperation()));

        newChildDescriptors.add(this.createChildParameter(
                PapyrusWidgetsPackage.Literals.MONO_REFERENCE_WIDGET_DESCRIPTION__UNSET_OPERATION,
                PapyrusWidgetsFactory.eINSTANCE.createMonoReferenceUnsetOperation()));

        newChildDescriptors.add(this.createChildParameter(
                PapyrusWidgetsPackage.Literals.MONO_REFERENCE_WIDGET_DESCRIPTION__CLEAR_OPERATION,
                PapyrusWidgetsFactory.eINSTANCE.createClearReferenceOperation()));

        newChildDescriptors.add(this.createChildParameter(
                PapyrusWidgetsPackage.Literals.MONO_REFERENCE_WIDGET_DESCRIPTION__CLICK_OPERATION,
                PapyrusWidgetsFactory.eINSTANCE.createClickReferenceValueOperation()));

        newChildDescriptors
                .add(this.createChildParameter(PapyrusWidgetsPackage.Literals.MONO_REFERENCE_WIDGET_DESCRIPTION__STYLE,
        ...
        newChildDescriptors.add(this.createChildParameter(
                PapyrusWidgetsPackage.Literals.MONO_REFERENCE_WIDGET_DESCRIPTION__CONDITIONAL_STYLES,
                ReferenceFactory.eINSTANCE.createConditionalReferenceWidgetDescriptionStyle()));
    }
