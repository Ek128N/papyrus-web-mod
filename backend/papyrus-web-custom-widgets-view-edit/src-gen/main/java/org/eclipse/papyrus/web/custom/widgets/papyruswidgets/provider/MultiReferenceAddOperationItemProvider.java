...
public class MultiReferenceAddOperationItemProvider extends ItemProviderAdapter
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(this.createChildParameter(PapyrusWidgetsPackage.Literals.MULTI_REFERENCE_ADD_OPERATION__BODY, ViewFactory.eINSTANCE.createLet()));

        newChildDescriptors.add(this.createChildParameter(PapyrusWidgetsPackage.Literals.MULTI_REFERENCE_ADD_OPERATION__BODY, ViewFactory.eINSTANCE.createIf()));
    }
