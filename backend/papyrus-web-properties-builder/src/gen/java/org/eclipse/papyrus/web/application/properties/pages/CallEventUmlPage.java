...
public class CallEventUmlPage {
    ...
    public CallEventUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("callEvent_uml_pageFrom", "uml::CallEvent", "aql:'UML'", "${formPreconditionExpression}");
    }
