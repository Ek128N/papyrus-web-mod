...
public class SequenceNodeUmlPage {
    ...
    public SequenceNodeUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("sequenceNode_uml_pageFrom", "uml::SequenceNode", "aql:'UML'", "${formPreconditionExpression}");
    }
