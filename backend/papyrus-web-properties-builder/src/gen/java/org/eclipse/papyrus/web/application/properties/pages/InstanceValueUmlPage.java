...
public class InstanceValueUmlPage {
    ...
    public InstanceValueUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("instanceValue_uml_pageFrom", "uml::InstanceValue", "aql:'UML'", "${formPreconditionExpression}");
    }
