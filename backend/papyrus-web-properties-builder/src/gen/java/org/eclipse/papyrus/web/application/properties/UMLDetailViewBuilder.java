...
public class UMLDetailViewBuilder {
    ...
    public List<PageDescription> createPages() {
        ...
        pages.add(new ActionInputPinUmlPageCustomImpl(factory).create());
        ...
        pages.add(new ConnectorEndUmlPageCustomImpl(factory).create());
        ...
        pages.add(new ExtensionEndUmlPageCustomImpl(factory).create());
        ...
        pages.add(new InputPinUmlPageCustomImpl(factory).create());
        ...
        pages.add(new OutputPinUmlPageCustomImpl(factory).create());
        ...
        pages.add(new ParameterUmlPageCustomImpl(factory).create());
        ...
        pages.add(new PropertyUmlPageCustomImpl(factory).create());
        ...
        pages.add(new ValuePinUmlPageCustomImpl(factory).create());
        pages.add(new ValueSpecificationActionUmlPage(factory).create());
        pages.add(new VariableUmlPageCustomImpl(factory).create());
