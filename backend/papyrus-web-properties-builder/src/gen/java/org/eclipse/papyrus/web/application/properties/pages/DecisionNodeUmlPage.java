...
public class DecisionNodeUmlPage {
    ...
    public DecisionNodeUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("decisionNode_uml_pageFrom", "uml::DecisionNode", "aql:'UML'", "${formPreconditionExpression}");
    }
