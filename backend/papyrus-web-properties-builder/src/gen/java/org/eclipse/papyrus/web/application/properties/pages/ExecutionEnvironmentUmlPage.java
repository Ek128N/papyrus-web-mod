...
public class ExecutionEnvironmentUmlPage {
    ...
    public ExecutionEnvironmentUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("executionEnvironment_uml_pageFrom", "uml::ExecutionEnvironment", "aql:'UML'", "${formPreconditionExpression}");
    }
