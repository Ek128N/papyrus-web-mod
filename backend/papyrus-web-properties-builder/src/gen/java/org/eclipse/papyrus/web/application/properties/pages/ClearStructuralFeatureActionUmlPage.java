...
public class ClearStructuralFeatureActionUmlPage {
    ...
    public ClearStructuralFeatureActionUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("clearStructuralFeatureAction_uml_pageFrom", "uml::ClearStructuralFeatureAction", "aql:'UML'", "${formPreconditionExpression}");
    }
