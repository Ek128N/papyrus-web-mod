...
public class CollaborationUseUmlPage {
    ...
    public CollaborationUseUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("collaborationUse_uml_pageFrom", "uml::CollaborationUse", "aql:'UML'", "${formPreconditionExpression}");
    }
