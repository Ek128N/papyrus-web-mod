...
public class ActionExecutionSpecificationUmlPage {
    ...
    public ActionExecutionSpecificationUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("actionExecutionSpecification_uml_pageFrom", "uml::ActionExecutionSpecification", "aql:'UML'", "${formPreconditionExpression}");
    }
