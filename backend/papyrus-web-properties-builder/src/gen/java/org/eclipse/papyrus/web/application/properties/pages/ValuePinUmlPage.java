...
public class ValuePinUmlPage {
    ...
    public ValuePinUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("valuePin_uml_pageFrom", "uml::ValuePin", "aql:'UML'", "${formPreconditionExpression}");
    }
