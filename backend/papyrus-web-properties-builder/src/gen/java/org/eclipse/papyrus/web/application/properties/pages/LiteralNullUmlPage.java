...
public class LiteralNullUmlPage {
    ...
    public LiteralNullUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("literalNull_uml_pageFrom", "uml::LiteralNull", "aql:'UML'", "${formPreconditionExpression}");
    }
