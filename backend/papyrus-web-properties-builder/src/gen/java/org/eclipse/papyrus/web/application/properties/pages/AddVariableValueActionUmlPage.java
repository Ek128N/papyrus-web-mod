...
public class AddVariableValueActionUmlPage {
    ...
    public AddVariableValueActionUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("addVariableValueAction_uml_pageFrom", "uml::AddVariableValueAction", "aql:'UML'", "${formPreconditionExpression}");
    }
