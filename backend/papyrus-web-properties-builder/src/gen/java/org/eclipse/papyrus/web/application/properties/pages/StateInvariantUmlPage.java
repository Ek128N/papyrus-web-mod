...
public class StateInvariantUmlPage {
    ...
    public StateInvariantUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("stateInvariant_uml_pageFrom", "uml::StateInvariant", "aql:'UML'", "${formPreconditionExpression}");
    }
