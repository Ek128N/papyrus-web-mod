...
public class BehaviorExecutionSpecificationUmlPage {
    ...
    public BehaviorExecutionSpecificationUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("behaviorExecutionSpecification_uml_pageFrom", "uml::BehaviorExecutionSpecification", "aql:'UML'", "${formPreconditionExpression}");
    }
