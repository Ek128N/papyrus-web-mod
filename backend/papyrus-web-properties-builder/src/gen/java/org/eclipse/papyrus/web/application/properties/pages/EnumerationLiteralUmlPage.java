...
public class EnumerationLiteralUmlPage {
    ...
    public EnumerationLiteralUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("enumerationLiteral_uml_pageFrom", "uml::EnumerationLiteral", "aql:'UML'", "${formPreconditionExpression}");
    }
