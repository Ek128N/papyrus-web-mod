...
public class InterfaceRealizationUmlPage {
    ...
    public InterfaceRealizationUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("interfaceRealization_uml_pageFrom", "uml::InterfaceRealization", "aql:'UML'", "${formPreconditionExpression}");
    }
