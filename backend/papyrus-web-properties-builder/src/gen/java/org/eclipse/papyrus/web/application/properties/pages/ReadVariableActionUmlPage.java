...
public class ReadVariableActionUmlPage {
    ...
    public ReadVariableActionUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("readVariableAction_uml_pageFrom", "uml::ReadVariableAction", "aql:'UML'", "${formPreconditionExpression}");
    }
