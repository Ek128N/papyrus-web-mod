...
public class FunctionBehaviorUmlPage {
    ...
    public FunctionBehaviorUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("functionBehavior_uml_pageFrom", "uml::FunctionBehavior", "aql:'UML'", "${formPreconditionExpression}");
    }
