...
public class InteractionUmlPage {
    ...
    public InteractionUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("interaction_uml_pageFrom", "uml::Interaction", "aql:'UML'", "${formPreconditionExpression}");
    }
