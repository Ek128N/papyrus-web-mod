...
public class TimeExpressionUmlPage {
    ...
    public TimeExpressionUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("timeExpression_uml_pageFrom", "uml::TimeExpression", "aql:'UML'", "${formPreconditionExpression}");
    }
