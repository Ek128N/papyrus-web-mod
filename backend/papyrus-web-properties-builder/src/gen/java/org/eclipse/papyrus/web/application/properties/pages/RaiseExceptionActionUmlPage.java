...
public class RaiseExceptionActionUmlPage {
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("raiseExceptionAction_uml_pageFrom", "uml::RaiseExceptionAction", "aql:'UML'", "");
    }
    ...
    protected void addException(GroupDescription group) {
        WidgetDescription widget = viewElementFactory.createReferenceDescription("exception", "aql:'Exception'", "aql:self.getFeatureDescription('exception')",
                "aql:self.eClass().getEStructuralFeature('exception').changeable", "aql:'exception'", "");
        group.getChildren().add(widget);
    }
