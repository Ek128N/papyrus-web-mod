...
public class ExpansionRegionUmlPage {
    ...
    public ExpansionRegionUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected void addMode(GroupDescription group) {
        WidgetDescription widget = viewElementFactory.createSelectDescription("mode", "aql:'Mode'",
                ...
                "aql:self.eClass().getEStructuralFeature('mode').eType.oclAsType(ecore::EEnum).eLiterals", "aql:candidate.name");
        group.getWidgets().add(widget);
    }
