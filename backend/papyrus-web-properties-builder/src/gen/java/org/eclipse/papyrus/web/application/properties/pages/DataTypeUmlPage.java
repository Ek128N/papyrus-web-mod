...
public class DataTypeUmlPage {
    ...
    public DataTypeUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("dataType_uml_pageFrom", "uml::DataType", "aql:'UML'", "${formPreconditionExpression}");
    }
