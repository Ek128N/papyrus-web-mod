...
public class ParameterSetUmlPage {
    ...
    public ParameterSetUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("parameterSet_uml_pageFrom", "uml::ParameterSet", "aql:'UML'", "${formPreconditionExpression}");
    }
