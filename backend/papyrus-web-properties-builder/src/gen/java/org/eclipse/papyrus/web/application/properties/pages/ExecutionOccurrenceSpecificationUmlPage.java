...
public class ExecutionOccurrenceSpecificationUmlPage {
    ...
    public ExecutionOccurrenceSpecificationUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("executionOccurrenceSpecification_uml_pageFrom", "uml::ExecutionOccurrenceSpecification", "aql:'UML'", "${formPreconditionExpression}");
    }
