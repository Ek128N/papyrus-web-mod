...
public class FinalStateUmlPage {
    ...
    public FinalStateUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("finalState_uml_pageFrom", "uml::FinalState", "aql:'UML'", "${formPreconditionExpression}");
    }
