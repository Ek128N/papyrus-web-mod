...
public class IntervalConstraintUmlPage {
    ...
    public IntervalConstraintUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("intervalConstraint_uml_pageFrom", "uml::IntervalConstraint", "aql:'UML'", "${formPreconditionExpression}");
    }
