...
public class ProtocolTransitionUmlPage {
    ...
    public ProtocolTransitionUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("protocolTransition_uml_pageFrom", "uml::ProtocolTransition", "aql:'UML'", "${formPreconditionExpression}");
    }
