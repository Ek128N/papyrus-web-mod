...
public class OpaqueExpressionUmlPage {
    ...
    public OpaqueExpressionUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("opaqueExpression_uml_pageFrom", "uml::OpaqueExpression", "aql:'UML'", "${formPreconditionExpression}");
    }
