...
public class ProtocolStateMachineUmlPage {
    ...
    public ProtocolStateMachineUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("protocolStateMachine_uml_pageFrom", "uml::ProtocolStateMachine", "aql:'UML'", "${formPreconditionExpression}");
    }
