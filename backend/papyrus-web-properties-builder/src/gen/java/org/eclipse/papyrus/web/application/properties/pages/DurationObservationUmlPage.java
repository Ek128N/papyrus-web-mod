...
public class DurationObservationUmlPage {
    ...
    public DurationObservationUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("durationObservation_uml_pageFrom", "uml::DurationObservation", "aql:'UML'", "${formPreconditionExpression}");
    }
    ...
    protected void addFirstEvent(GroupDescription group) {
        WidgetDescription widget = viewElementFactory.createListDescription("firstEvent", "First event", "feature:firstEvent", "", "aql:false");
        group.getWidgets().add(widget);
    }
