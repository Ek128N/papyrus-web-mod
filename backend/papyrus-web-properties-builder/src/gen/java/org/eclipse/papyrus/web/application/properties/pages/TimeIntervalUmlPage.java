...
public class TimeIntervalUmlPage {
    ...
    public TimeIntervalUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("timeInterval_uml_pageFrom", "uml::TimeInterval", "aql:'UML'", "${formPreconditionExpression}");
    }
