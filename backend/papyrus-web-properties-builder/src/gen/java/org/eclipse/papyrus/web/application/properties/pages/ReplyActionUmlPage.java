...
public class ReplyActionUmlPage {
    ...
    public ReplyActionUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("replyAction_uml_pageFrom", "uml::ReplyAction", "aql:'UML'", "${formPreconditionExpression}");
    }
