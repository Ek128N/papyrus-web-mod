...
public class ReadLinkObjectEndQualifierActionUmlPage {
    ...
    public ReadLinkObjectEndQualifierActionUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("readLinkObjectEndQualifierAction_uml_pageFrom", "uml::ReadLinkObjectEndQualifierAction", "aql:'UML'", "${formPreconditionExpression}");
    }
