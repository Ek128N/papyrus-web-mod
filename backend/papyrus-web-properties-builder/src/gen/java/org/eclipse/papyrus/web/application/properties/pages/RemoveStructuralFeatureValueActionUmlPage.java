...
public class RemoveStructuralFeatureValueActionUmlPage {
    ...
    public RemoveStructuralFeatureValueActionUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("removeStructuralFeatureValueAction_uml_pageFrom", "uml::RemoveStructuralFeatureValueAction", "aql:'UML'", "${formPreconditionExpression}");
    }
