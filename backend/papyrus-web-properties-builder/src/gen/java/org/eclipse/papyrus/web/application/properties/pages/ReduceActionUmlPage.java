...
public class ReduceActionUmlPage {
    ...
    public ReduceActionUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("reduceAction_uml_pageFrom", "uml::ReduceAction", "aql:'UML'", "${formPreconditionExpression}");
    }
