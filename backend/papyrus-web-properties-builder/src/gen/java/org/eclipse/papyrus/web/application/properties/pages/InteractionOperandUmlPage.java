...
public class InteractionOperandUmlPage {
    ...
    public InteractionOperandUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("interactionOperand_uml_pageFrom", "uml::InteractionOperand", "aql:'UML'", "${formPreconditionExpression}");
    }
