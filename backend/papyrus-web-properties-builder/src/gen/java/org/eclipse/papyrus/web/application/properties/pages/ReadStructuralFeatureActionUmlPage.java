...
public class ReadStructuralFeatureActionUmlPage {
    ...
    public ReadStructuralFeatureActionUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("readStructuralFeatureAction_uml_pageFrom", "uml::ReadStructuralFeatureAction", "aql:'UML'", "${formPreconditionExpression}");
    }
