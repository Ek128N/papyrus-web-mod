...
public class ActionInputPinUmlPage {
    ...
    public ActionInputPinUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("actionInputPin_uml_pageFrom", "uml::ActionInputPin", "aql:'UML'", "${formPreconditionExpression}");
    }
