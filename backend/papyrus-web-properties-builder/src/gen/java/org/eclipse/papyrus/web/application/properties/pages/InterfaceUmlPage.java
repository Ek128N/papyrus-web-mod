...
public class InterfaceUmlPage {
    ...
    public InterfaceUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("interface_uml_pageFrom", "uml::Interface", "aql:'UML'", "${formPreconditionExpression}");
    }
