...
public class CreateObjectActionUmlPage {
    ...
    public CreateObjectActionUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("createObjectAction_uml_pageFrom", "uml::CreateObjectAction", "aql:'UML'", "${formPreconditionExpression}");
    }
