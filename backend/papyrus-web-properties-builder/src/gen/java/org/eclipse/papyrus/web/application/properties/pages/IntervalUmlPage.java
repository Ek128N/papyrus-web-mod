...
public class IntervalUmlPage {
    ...
    public IntervalUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("interval_uml_pageFrom", "uml::Interval", "aql:'UML'", "${formPreconditionExpression}");
    }
