...
public class InteractionConstraintUmlPage {
    ...
    public InteractionConstraintUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("interactionConstraint_uml_pageFrom", "uml::InteractionConstraint", "aql:'UML'", "${formPreconditionExpression}");
    }
