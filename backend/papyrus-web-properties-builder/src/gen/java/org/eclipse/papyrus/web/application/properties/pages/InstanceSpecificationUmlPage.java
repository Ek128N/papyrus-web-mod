...
public class InstanceSpecificationUmlPage {
    ...
    public InstanceSpecificationUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("instanceSpecification_uml_pageFrom", "uml::InstanceSpecification", "aql:'UML'", "${formPreconditionExpression}");
    }
