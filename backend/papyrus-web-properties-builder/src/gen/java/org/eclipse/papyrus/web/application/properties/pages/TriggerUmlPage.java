...
public class TriggerUmlPage {
    ...
    public TriggerUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("trigger_uml_pageFrom", "uml::Trigger", "aql:'UML'", "${formPreconditionExpression}");
    }
