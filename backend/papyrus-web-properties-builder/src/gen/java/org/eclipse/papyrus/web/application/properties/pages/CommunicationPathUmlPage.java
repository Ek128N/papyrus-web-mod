...
public class CommunicationPathUmlPage {
    ...
    public CommunicationPathUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("communicationPath_uml_pageFrom", "uml::CommunicationPath", "aql:'UML'", "${formPreconditionExpression}");
    }
