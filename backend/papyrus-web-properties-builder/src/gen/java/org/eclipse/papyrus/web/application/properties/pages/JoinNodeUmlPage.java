...
public class JoinNodeUmlPage {
    ...
    public JoinNodeUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("joinNode_uml_pageFrom", "uml::JoinNode", "aql:'UML'", "${formPreconditionExpression}");
    }
    ...
    protected void addIsCombineDuplicate(GroupDescription group) {
        WidgetDescription widget = viewElementFactory.createCheckboxDescription("isCombineDuplicate", "aql:'Is combine duplicate'", "feature:isCombineDuplicate",
                "aql:self.set('isCombineDuplicate',newValue)", "aql:self.getFeatureDescription('isCombineDuplicate')");
        group.getWidgets().add(widget);
    }
