...
public class ManifestationUmlPage {
    ...
    public ManifestationUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("manifestation_uml_pageFrom", "uml::Manifestation", "aql:'UML'", "${formPreconditionExpression}");
    }
