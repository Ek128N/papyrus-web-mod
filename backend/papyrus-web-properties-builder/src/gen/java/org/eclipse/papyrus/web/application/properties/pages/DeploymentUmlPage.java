...
public class DeploymentUmlPage {
    ...
    public DeploymentUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("deployment_uml_pageFrom", "uml::Deployment", "aql:'UML'", "${formPreconditionExpression}");
    }
