...
public class ConstraintUmlPage {
    ...
    public ConstraintUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("constraint_uml_pageFrom", "uml::Constraint", "aql:'UML'", "${formPreconditionExpression}");
    }
