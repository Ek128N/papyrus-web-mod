...
public class CollaborationUmlPage {
    ...
    public CollaborationUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("collaboration_uml_pageFrom", "uml::Collaboration", "aql:'UML'", "${formPreconditionExpression}");
    }
