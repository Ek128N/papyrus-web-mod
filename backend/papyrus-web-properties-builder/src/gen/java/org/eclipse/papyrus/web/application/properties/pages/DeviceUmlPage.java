...
public class DeviceUmlPage {
    ...
    public DeviceUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("device_uml_pageFrom", "uml::Device", "aql:'UML'", "${formPreconditionExpression}");
    }
