...
public class OpaqueBehaviorUmlPage {
    ...
    public OpaqueBehaviorUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("opaqueBehavior_uml_pageFrom", "uml::OpaqueBehavior", "aql:'UML'", "${formPreconditionExpression}");
    }
