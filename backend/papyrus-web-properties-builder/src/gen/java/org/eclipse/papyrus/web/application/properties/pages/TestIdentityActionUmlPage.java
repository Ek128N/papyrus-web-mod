...
public class TestIdentityActionUmlPage {
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("testIdentityAction_uml_pageFrom", "uml::TestIdentityAction", "aql:'UML'", "");
    }
    ...
    protected void addFirst(GroupDescription group) {
        WidgetDescription widget = viewElementFactory.createReferenceDescription("first", "aql:'First'", "aql:self.getFeatureDescription('first')",
                "aql:self.eClass().getEStructuralFeature('first').changeable", "aql:'first'", "");
        group.getChildren().add(widget);
    }
    ...
    protected void addSecond(GroupDescription group) {
        WidgetDescription widget = viewElementFactory.createReferenceDescription("second", "aql:'Second'", "aql:self.getFeatureDescription('second')",
                "aql:self.eClass().getEStructuralFeature('second').changeable", "aql:'second'", "");
        group.getChildren().add(widget);
    }
