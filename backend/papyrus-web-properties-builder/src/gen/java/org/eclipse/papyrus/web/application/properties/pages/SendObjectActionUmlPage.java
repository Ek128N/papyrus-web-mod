...
public class SendObjectActionUmlPage {
    ...
    public SendObjectActionUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("sendObjectAction_uml_pageFrom", "uml::SendObjectAction", "aql:'UML'", "${formPreconditionExpression}");
    }
