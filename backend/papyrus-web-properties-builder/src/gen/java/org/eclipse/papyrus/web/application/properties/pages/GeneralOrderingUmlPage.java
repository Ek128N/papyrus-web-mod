...
public class GeneralOrderingUmlPage {
    ...
    public GeneralOrderingUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("generalOrdering_uml_pageFrom", "uml::GeneralOrdering", "aql:'UML'", "${formPreconditionExpression}");
    }
