...
public class BroadcastSignalActionUmlPage {
    ...
    public BroadcastSignalActionUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("broadcastSignalAction_uml_pageFrom", "uml::BroadcastSignalAction", "aql:'UML'", "${formPreconditionExpression}");
    }
