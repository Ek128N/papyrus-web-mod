...
public class InformationFlowUmlPage {
    ...
    public InformationFlowUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("informationFlow_uml_pageFrom", "uml::InformationFlow", "aql:'UML'", "${formPreconditionExpression}");
    }
