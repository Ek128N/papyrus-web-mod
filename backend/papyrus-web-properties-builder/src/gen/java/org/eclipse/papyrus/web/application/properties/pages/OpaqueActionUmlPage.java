...
public class OpaqueActionUmlPage {
    ...
    public OpaqueActionUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("opaqueAction_uml_pageFrom", "uml::OpaqueAction", "aql:'UML'", "${formPreconditionExpression}");
    }
