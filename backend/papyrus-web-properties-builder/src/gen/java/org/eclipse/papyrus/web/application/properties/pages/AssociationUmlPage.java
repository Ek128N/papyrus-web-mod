...
public class AssociationUmlPage {
    ...
    public AssociationUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("association_uml_pageFrom", "uml::Association", "aql:'UML'", "${formPreconditionExpression}");
    }
