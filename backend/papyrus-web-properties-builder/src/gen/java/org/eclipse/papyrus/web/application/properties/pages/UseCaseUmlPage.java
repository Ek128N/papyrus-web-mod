...
public class UseCaseUmlPage {
    ...
    public UseCaseUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("useCase_uml_pageFrom", "uml::UseCase", "aql:'UML'", "${formPreconditionExpression}");
    }
