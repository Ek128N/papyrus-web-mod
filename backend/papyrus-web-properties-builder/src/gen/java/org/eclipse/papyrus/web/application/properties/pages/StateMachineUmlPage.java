...
public class StateMachineUmlPage {
    ...
    public StateMachineUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("stateMachine_uml_pageFrom", "uml::StateMachine", "aql:'UML'", "${formPreconditionExpression}");
    }
