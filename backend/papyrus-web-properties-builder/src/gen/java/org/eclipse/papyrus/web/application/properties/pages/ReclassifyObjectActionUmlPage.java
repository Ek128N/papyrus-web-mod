...
public class ReclassifyObjectActionUmlPage {
    ...
    public ReclassifyObjectActionUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("reclassifyObjectAction_uml_pageFrom", "uml::ReclassifyObjectAction", "aql:'UML'", "${formPreconditionExpression}");
    }
