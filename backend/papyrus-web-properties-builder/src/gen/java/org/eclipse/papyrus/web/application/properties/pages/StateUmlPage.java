...
public class StateUmlPage {
    ...
    public StateUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("state_uml_pageFrom", "uml::State", "aql:'UML'", "${formPreconditionExpression}");
    }
