...
public class ClearAssociationActionUmlPage {
    ...
    public ClearAssociationActionUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("clearAssociationAction_uml_pageFrom", "uml::ClearAssociationAction", "aql:'UML'", "${formPreconditionExpression}");
    }
