...
public class CallBehaviorActionUmlPage {
    ...
    public CallBehaviorActionUmlPage(ViewElementsFactory viewElementFactory) {
        super();
    ...
    protected FormDescription createFrom() {
        return viewElementFactory.createFormDescription("callBehaviorAction_uml_pageFrom", "uml::CallBehaviorAction", "aql:'UML'", "${formPreconditionExpression}");
    }
