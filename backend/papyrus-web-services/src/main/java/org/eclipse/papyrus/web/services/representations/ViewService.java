...
public class ViewService implements IViewService {
    ...
    private final PapyrusRepresentationDescriptionRegistry papyrusRegistry;

    public ViewService(IDocumentRepository documentRepository, EPackage.Registry ePackageRegistry, PapyrusRepresentationDescriptionRegistry papyrusRegistry) {
    ...
    public Optional<RepresentationDescription> getRepresentationDescription(String representationDescriptionId) {
        ...
        Optional<RepresentationDescription> searchedView = this.papyrusRegistry.getAll().stream()//
                .filter(d -> representationDescriptionId.equals(this.getDescriptionId(d)))//
                .map(desc -> desc).findFirst();

        if (searchedView.isEmpty()) {
            ...
            for (DocumentEntity documentEntity : allDocuments) {
                ...
                // @formatter:off
                searchedView = this.getViewDefinitions(resource)
