...
import org.eclipse.papyrus.web.persistence.repositories.IRepresentationRepository;
...
public class RepresentationService implements IRepresentationService, IRepresentationPersistenceService, IDanglingRepresentationDeletionService {
    ...
    private static final String TIMER_NAME = "papyrusweb_representation_save"; //$NON-NLS-1$
