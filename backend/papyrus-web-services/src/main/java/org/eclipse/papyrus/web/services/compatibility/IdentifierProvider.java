 ...
 *******************************************************************************/
package org.eclipse.papyrus.web.services.compatibility;
...
public class IdentifierProvider implements IIdentifierProvider {
    ...
    public IdentifierProvider(IIdMappingRepository repository, @Value("${papyrus.web.identifierProvider.cacheSize:10000}") int cacheSize) {
